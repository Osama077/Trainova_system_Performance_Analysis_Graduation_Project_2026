...
CREATE Or Alter VIEW InjuriesData.View_PlayerInjury_Player_Injury
        with SCHEMABINDING
AS
SELECT
    ...
    i.AverageRecoveryTimeInDayes AS AverageRecoveryTimeInDayes,
    pi.Status AS Status,
...
GO
create unique clustered index IX_View_PlayerInjury_Player_Injury_Id on InjuriesData.View_PlayerInjury_Player_Injury(PlayerInjuryId);
